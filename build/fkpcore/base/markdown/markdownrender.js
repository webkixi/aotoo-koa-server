...
exports.default = function (render) {
  ...
  render.heading = function (text, level, raw) {
    ...
    var id;
    if (/[\u4e00-\u9fa5]/g.test(raw)) id = config.id || _.uniqueId('fkp-anchor-');else {
...
//# sourceMappingURL=../../../maps/fkpcore/base/markdown/markdownrender.js.map
